...
For the data summary I print the number of images in each of the sets, as well as their shape and the number of classes or labels that exist in the data

In the visualization I display an histogram based on the labels to see how many of each kind we have.
To get an idea of how do each of the signs look, I print one of each of the labels.

* **Design and Test a Model Architecture**

*Pre-processing:* for pre-processing I decided to go with gray-scale and normalization as this combination was giving the best results, I tried converting the images to hsv but the accuracy decreased more than without any preprocessing at all

*Model Architecture* is a LeNet5 with dropout, it consists of 2 convolutional layers and 3 fully connected ones
